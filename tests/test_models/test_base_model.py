...
class TestBaseModel(unittest.TestCase):
    ...
    def test_to_dict_noAditonalAttr(self):
        ''' Checking to_dict w/o additional Attributes'''
        my_model = BaseModel()
